...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [MOUSE] = LAYOUT( \
    KC_TAB,   KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_RPRN,  KC_AMPR, KC_Y,   KC_WH_L, KC_WH_D, KC_WH_R,KC_P,    KC_MINS , \
    KC_LCTL,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_DLR,   KC_BSPC, KC_H,   KC_BTN1, KC_WH_U, KC_BTN2,KC_SCLN, KC_LBRC , \
    KC_LSFT,  KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_ESC,   KC_B   , KC_N,   KC_M,    KC_BTN3, KC_DOT, KC_SLSH, KC_RBRC , \

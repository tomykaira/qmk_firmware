...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [BASE] = LAYOUT( \
    ...
    KC_LSFT,  KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_ESC,   MO(MOUSE), KC_N,   KC_M,    KC_COMM, KC_DOT, KC_SLSH, KC_RBRC , \
    KC_GRV,   KC_CIRC, KC_LALT, KC_LGUI, MO(SYMB),KC_SPC,  MO(META), KC_EQL , KC_LSFT, KC_UNDS, MO(MOUSE), KC_EQL, KC_AT,   KC_BSLS,   \
  ...
  [MOUSE] = LAYOUT( \
    KC_TAB,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,    KC_AMPR, KC_Y,   KC_WH_L, KC_WH_D, KC_WH_R,KC_P,    KC_MINS , \
    KC_LCTL,  KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,   KC_BSPC, KC_H,   KC_BTN1, KC_WH_U, KC_BTN2,KC_SCLN, KC_LBRC , \
    KC_LSFT,  RGB_TOG,    RGB_MODE_FORWARD,    KC_C,    KC_V,    KC_B,    KC_ESC,   KC_B   , KC_N,   KC_M,    KC_BTN3, KC_DOT, KC_SLSH, KC_RBRC , \

...
[_QWERTY] = LAYOUT_ortho_4x12(
   ...
   KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    _______, _______, KC_N,    KC_M,    KC_COMMA, KC_DOT, KC_SPC, \
   _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______ \
),

 [_QWERTY_L] = LAYOUT_ortho_4x12( \
  KC_EXCLAIM, KC_DQUO, KC_HASH, KC_DLR,  KC_PERC, _______, _______, KC_T, KC_R, KC_E, KC_W, KC_Q, \
  KC_QUES,    KC_ASTR, KC_GRV,  KC_PIPE, KC_BSLS, _______, _______, KC_G, KC_F, KC_D, KC_S, KC_A, \
  KC_PLUS,    KC_TILD, KC_AT,   KC_CIRC, KC_SLSH, _______, _______, KC_B, KC_V, KC_C, KC_X, KC_Z, \
  _______,    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______ \
),

[_NUM] = LAYOUT_ortho_4x12( \
  KC_7,    KC_8,    KC_9,    KC_ASTR,  KC_F5,  _______, _______, KC_F1,   KC_7,   KC_8,   KC_9,   KC_F5,  \
  KC_4,    KC_5,    KC_6,    KC_PLUS,  KC_5,   _______, _______, KC_F6,   KC_4,   KC_5,   KC_6,    _______,  \
  KC_1,    KC_2,    KC_3,    KC_0,     KC_DOT, _______, _______, KC_0,    KC_1,   KC_2,   KC_3, KC_0, \
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______ \
),

[_FUNC] = LAYOUT_ortho_4x12( \
  KC_ESC,   _______, _______, _______, _______, _______, _______, _______, KC_LPRN, KC_RPRN, _______, KC_BSPC, \
  KC_TAB ,  KC_UP,   _______, KC_LT,   KC_GT,   _______, _______, _______, KC_LBRC, KC_RBRC, KC_ENT,  _______, \
